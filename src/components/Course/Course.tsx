...
const Course = ({course}: IProduct) => {
  const {_id, title, price, img, rating, seat, category, description} = course;
  // console.log(course)
      ...
      marginTop: '15px'
                    ...
                    <div className="p-4 bg-white dark:bg-gray-700">
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <span className="text-sm text-gray-600 dark:text-gray-400">Gorkha,Nepal</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between ">
                            <div className="flex items-center">
                                <a href="" className="mr-2 text-blue-700 dark:text-gray-400">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                                        className="bi bi-calendar-day" viewBox="0 0 16 16">
                                        <path
